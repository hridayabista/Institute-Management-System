 ...
 * @author _Spoidey-
 */
public class AddDailyEntry extends javax.swing.JFrame {
...
//    Setting Computer Courses
    public void setDailyEntry() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from adddailyentry");
...
//    To Add Computer Courses
    public boolean addDailyEntry() {
        ...
        serviceName = txt_serviceName.getText();
        ...
        try {
            ...
            String sql = "insert into adddailyentry values(?, ?)";
...
//  To Update Computer Courses    
    public boolean updateDailyEntry() {
        ...
        try {
            ...
            Connection con = DBConnection.getConnection();
            String sql = "update adddailyentry set service_name = ? where id = ?";
            PreparedStatement pst = con.prepareStatement(sql);
...
//    To Delete Computer Course
    public boolean deleteDailyEntry() {
        ...
        try {
            ...
            Connection con = DBConnection.getConnection();
            String sql = "delete from adddailyentry where id = ?";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setInt(1, ID);
...
//    To clear all input fields
    ...
    private void initComponents() {
        ...
        txt_serviceName = new app.bolivia.swing.JCTextField();
        ...
        jLabel2.setText("ADD DAILY ENTRY");

        txt_serviceName.setBackground(new java.awt.Color(255, 255, 255));
        txt_serviceName.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 1, new java.awt.Color(0, 102, 255)));
        txt_serviceName.setForeground(new java.awt.Color(0, 0, 153));
        txt_serviceName.setFont(new java.awt.Font("Segoe UI Light", 0, 18)); // NOI18N
        ...
        courseName1.setText("Enter Service ID");
    ...
    private void dailyEntryTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dailyEntryTableMouseClicked
        ...
        txt_serviceName.setText(model.getValueAt(rowNo, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDailyEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddDailyEntry().setVisible(true);
            }
        });
    }
    ...
    private app.bolivia.swing.JCTextField txt_serviceName;
